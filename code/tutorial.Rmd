...
train_test2 <- iris2_tbl %>% 
  sdf_partition(training = 0.7, testing = 0.3)

training2_tbl <- train_test2$training
testing2_tbl <- train_test2$testing

# train logistic regression model
model_logr <- training2_tbl %>%
...
pred <- sdf_predict(model_logr, testing2_tbl) %>% 
  ft_string_indexer("Species", "Species_inx")
ml_binary_classification_eval(pred, "Species_inx", "probability", metric = "areaUnderROC" )
```
